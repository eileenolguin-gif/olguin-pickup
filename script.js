...
const translations = {
  es: {
    ...
    'compromiso.title': 'Nuestro compromiso contigo',
    'compromiso.lead': 'No prometemos ser los más baratos. Prometemos que cada traslado se trata con el mismo cuidado que le daríamos a nuestra propia familia.',
    'compromiso.item1.strong': 'Puntualidad real.',
    'compromiso.item1.text': 'Llegamos cuando dijimos que llegaríamos, sin excusas.',
    'compromiso.item2.strong': 'Cero intermediarios.',
    'compromiso.item2.text': 'Hablas directo con quienes manejan y coordinan, no con un call center.',
    'compromiso.item3.strong': 'Cuidado, no solo transporte.',
  ...
  en: {
    ...
    'compromiso.title': 'Our commitment to you',
    'compromiso.lead': "We don't promise to be the cheapest. We promise that every transfer is handled with the same care we'd give our own family.",
    'compromiso.item1.strong': 'Real punctuality.',
    'compromiso.item1.text': 'We arrive when we said we would, no excuses.',
    'compromiso.item2.strong': 'Zero middlemen.',
    'compromiso.item2.text': 'You speak directly with the people who drive and coordinate, not a call center.',
    'compromiso.item3.strong': 'Care, not just transport.',
  ...
  pt: {
    ...
    'compromiso.title': 'Nosso compromisso com você',
    'compromiso.lead': 'Não prometemos ser os mais baratos. Prometemos que cada traslado é tratado com o mesmo cuidado que daríamos à nossa própria família.',
    'compromiso.item1.strong': 'Pontualidade real.',
    'compromiso.item1.text': 'Chegamos quando dissemos que chegaríamos, sem desculpas.',
    'compromiso.item2.strong': 'Zero intermediários.',
    'compromiso.item2.text': 'Você fala diretamente com quem dirige e coordena, não com uma central de atendimento.',
    'compromiso.item3.strong': 'Cuidado, não apenas transporte.',
